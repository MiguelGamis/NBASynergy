...
CREATE TABLE IF NOT EXISTS `missingshotlocation` (
  `missingshotlocationID` int(11) NOT NULL AUTO_INCREMENT,
  `gameID` int(11) NOT NULL, 
  `time` int(11) NOT NULL, 
  `playerID` int(11) NOT NULL, 
  ...
  `Y` int(11) NOT NULL,
  `lineID` int(11) NOT NULL,
  PRIMARY KEY (`missingshotlocationID`),
  UNIQUE KEY `gameline` (`gameID`, `lineID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
--
-- Constraints for table `missingshotlocation`
--	
ALTER TABLE `missingshotlocation`
	ADD CONSTRAINT `missingshotlocation_ibfk_1` FOREIGN KEY (`gameID`) REFERENCES `game` (`gameID`) ON DELETE CASCADE;
ALTER TABLE `missingshotlocation` 
	ADD CONSTRAINT `missingshotlocation_ibfk_2` FOREIGN KEY (`playerID`) REFERENCES `player` (`playerID`) ON DELETE CASCADE;
