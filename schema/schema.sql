...
ALTER TABLE `playerteam`
  ...
  ADD CONSTRAINT `playerteam_ibfk_2` FOREIGN KEY (`teamID``) REFERENCES `team` (`gameID`) ON DELETE CASCADE;
...
ALTER TABLE `shot`
  ...
  ADD CONSTRAINT `shot_ibfk_2` FOREIGN KEY (`game`) REFERENCES `game` (`gameID`) ON DELETE CASCADE;